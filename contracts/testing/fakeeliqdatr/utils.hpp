...
ds_asset operator*( const ds_asset& token,const double value ) {
    return ds_asset(int64_t(token.amount*value), token.symbol);
}
...
static char *write_format_string(const char *f, t0 v0, t1 v1, t2 v2, t3 v3, t4 v4, t5 v5, t6 v6, t7 v7, t8 v8, t9 v9) {
    ds_uint a = 0;
    char chars[500];
    char *r = chars;
    const char *l = r + 500;
