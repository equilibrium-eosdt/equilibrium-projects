...
namespace eosiosystem {
...
#if 1
      eosio::print("\r\nsystem_contract::sellrex rex=");
      rex.print();
      eosio::print(" S0=");
      rexitr->total_lendable.print();
      eosio::print(" R0=");
      rexitr->total_rex.print();
      eosio::print(" eos=");
      proceeds.print();
#endif
   ...
   void system_contract::transfer_from_fund( const name& owner, const asset& amount )
   {
      ...
      if (amount > itr->balance) {
         eosio::print("\r\ninsufficient REX funds: amount=");
         amount.print();
         eosio::print(" > balance=");
         itr->balance.print();
      }
...
#if 1
         eosio::print("\r\nsystem_contract::buyrex eos=");
         payment.print();
         eosio::print(" S0=");
         itr->total_lendable.print();
         eosio::print(" R0=");
         itr->total_rex.print();
         eosio::print(" rex=");
         rex_received.print();
